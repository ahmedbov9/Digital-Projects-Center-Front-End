            ...
            {order.servicePaymentStatus === 'unpaid' && (
              <div style={{ width: 'fit-content' }}>
                ...
                <div className="w-100">
                  ...
                  <p className="text-muted fw-bold mt-3">
                    بعد الدفع الرجاء ارسال صورة من ايصال الدفع على الواتس اب او
                    الايميل الخاص بنا وسيتم تحديث حالة الدفع من قبلنا
                  </p>
                  <div className="d-flex justify-content-center gap-3">
                    <p className="text-muted fw-bold mt-3">
                      <span className="fw-bold">
                        ...
                        >
                          <FontAwesomeIcon icon={faWhatsapp} fontSize={'30'} />
                        </a>
                      </span>{' '}
                    </p>
                    <p className="text-muted fw-bold mt-3">
